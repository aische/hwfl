...
**Shipped (M8 + deepen + S2):** `examples/semantic-check/workflows/main.md` —
...
catalog-missing objects). One module; uses `meta.check_module`, `fs.find`,
pure `list` / `text` / `md` prelude helpers. Fixture:
