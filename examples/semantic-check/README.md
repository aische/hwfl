...
Deterministic semantic review (**layers 0–2b**) written **in pml**, not as a
...
```bash
cabal run pml -- run examples/semantic-check/workflows/main.md \
...
| | hwfi `examples/semantic-check` | pml (this) |
|--|-------------------------------|------------|
